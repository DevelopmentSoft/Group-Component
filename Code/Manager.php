                                                ...
                                                <?php
                                                    ...
                                                    // output data of each row
                                                        while($row = mysqli_fetch_assoc($eventresult)) {
                                                            echo "<tr><td>" . $row["Type"]. "</td><td><a target='_blank' href='ViewImg.php?id=".$row["ID"]."'>View Image</td><td><a target='_blank' href='View.php?id=".$row["ID"]."'>" . $row["File"]. "</td><td>" . $row["SubBy"]. "</td><td id='marker'>" . $row["DateSubmitted"]. "</td><td id='marker'>" . $row["Faculty"]. "</td></tr>";
                                                        }
                                                    }
                                                    else{
